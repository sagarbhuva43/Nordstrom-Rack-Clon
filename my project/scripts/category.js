...
function appendproducts(info, main) {
  ...
  info.map(function (data) {
    ...
    div4.innerHTML = `<span><i class = "fas fa-star"></i>
    <i class="fas fa-star"></i>
    <i class = "fas fa-star"></i>
    <i class = "fas fa-star"></i>
    <i class = "fas fa-star"></i></span>(${num})`;
    ...
    h2.innerText = `${num1}% off`;

    span3.append(h2);

    var ship = document.createElement("p");
    ship.className = "product-price-info";
    ship.innerText = "Free Shipping on Orders $89+";

    div11.append(span1, span2, span3, div4 , ship);
